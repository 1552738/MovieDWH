        ...
        try{
            ...
            if(conn!=null) {
                ...
                if (!Week.equals("")){
                    ...
                    if (!table.contains("Time"))table=table+",Time";
